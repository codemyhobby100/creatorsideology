      ...
      <div className=" container mx-auto items-center pt-[30px] pb-[50px] lg:pt-[50px]">
        ...
        >
            ...
            <SwiperSlide className="text-center">
              <img src={img1} alt="Customer logo 1" className="w-[150px] h-[50px]" />
            </SwiperSlide>
            <SwiperSlide>
              <img src={img2} alt="Customer logo 2" className="w-[150px] h-[50px]" />
            </SwiperSlide>
            <SwiperSlide>
              <img src={img3} alt="Customer logo 3" className="w-[150px] h-[50px]" />
            </SwiperSlide>
            <SwiperSlide>
              <img src={img4} alt="Customer logo 4" className="w-[150px] h-[50px]" />
            </SwiperSlide>
            <SwiperSlide>
              <img src={img5} alt="Customer logo 5" className="w-[150px] h-[50px]" />
            </SwiperSlide>
            <SwiperSlide>
              <img src={img6} alt="Customer logo 6" className="w-[150px] h-[50px]" />
            </SwiperSlide>
            <SwiperSlide>
              <img src={img1} alt="Customer logo 1" className="w-[150px] h-[50px]" />
            </SwiperSlide>
