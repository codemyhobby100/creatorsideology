    ...
    <div className="bg-black min-h-screen">
      <div className="container mx-auto py-10 px-4">
        <div className="flex flex-col md:flex-row gap-6">
          <div className="bg-[#E7FBFF] md:w-1/2 mt-[150px] p-[50px] rounded-[20px] flex flex-col justify-start">
          ...
          <div className="md:w-1/2 md:pt-[150px] pb-[50px] px-4">
            ...
            <form action="" className="w-full space-y-6">
              ...
              >
                Send a Message
                <span className="button-hover absolute group-hover:w-[1100px] group-hover:h-[1000px] group-hover:bottom-[-100%] group-hover:right-[-100%]"></span>
              </button>
            </form>
          </div>
        </div>
